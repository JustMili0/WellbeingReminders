package net.justmili.libsmini.v1.config;
...
import net.justmili.libsmini.v1.config.writer.PropertiesWriter;
...
public class ConfigLoader {
    ...
    public void loadOrCreate(CategoryItem root) {
        ...
        if (!file.exists()) {
            CoreLibsMini.LOGGER.info("No config found, creating defaults.");
